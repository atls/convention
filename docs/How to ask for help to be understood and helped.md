...
> _Поэтому во всем поступайте с людьми так, как хотите, чтобы они поступали с вами. В этом суть всего, что написано в Законе и в Книгах Пророков!_
>
> _Матфея 7:12_

От того, как сформулирован вопрос зависит и ответ. Золотое правило: представь, что _ты_ пытаешься ответить на вопрос.
...
_Почему я не могу преобразовать выражение типа `List<string>` в `List<object>`?_

не имеет никакого смысла, если убрать аргументы типа:

_Почему я не могу преобразовать выражение типа List в List?_
